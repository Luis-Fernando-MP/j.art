...
self.onmessage = event =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (action === EWorkerActions.GENERATE_FRAME && imageBitmap) yield generateImage(imageBitmap)
      if (action === EWorkerActions.GENERATE_FULL_VIEW && imagesBitmap) yield generateFullImage(imagesBitmap)
      if (action === EWorkerActions.CHANGE_OPACITY && imageBitmap && alpha) yield changeAlpha(imageBitmap, alpha)
    } catch (error) {
