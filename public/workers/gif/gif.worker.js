    ...
    ;(r.prototype.newPage = function () {
      ...
      (s.prototype.analyzePixels = function () {
        this.colorTab ||
          ...
          this.dither
            ? this.ditherPixels(this.dither.replace('-serpentine', ''), null !== this.dither.match(/-serpentine/))
            : this.indexPixels(),
          (this.pixels = null),
          (this.colorDepth = 8),
          (this.palSize = 7),
    ...
    function i(t, e) {
      ...
      function x(t, e, i, r, o) {
        for (var n, a, h = Math.abs(e - t), l = Math.min(e + t, s), u = e + 1, p = e - 1, f = 1; u < l || p > h; )
          (a = Q[f++]),
            u < l &&
              ((n = z[u++]), (n[0] -= (a * (n[0] - i)) / B), (n[1] -= (a * (n[1] - r)) / B), (n[2] -= (a * (n[2] - o)) / B)),
            p > h &&
              ((n = z[p--]), (n[0] -= (a * (n[0] - i)) / B), (n[1] -= (a * (n[1] - r)) / B), (n[2] -= (a * (n[2] - o)) / B))
      }
      function v(t, e, i) {
        ;(t = 0 | t), (e = 0 | e), (i = 0 | i)
        var r,
          ...
          l < s &&
            ...
            n >= a
              ...
              : (l++,
                ...
                r < 0 && (r = -r),
                (n += r),
                n < a && ((r = (0 | o[2]) - i), r < 0 && (r = -r), (n += r), n < a && ((a = n), (h = 0 | o[3]))))),
            u >= 0 &&
              ((o = z[u]),
              (n = e - (0 | o[1])),
              n >= a
  ...
  function (t, e) {
    function i(t, e, i, a) {
      ...
      function p(t, e) {
        var i, n, a, h, p, f, c
        for (
          v = t, C = !1, n_bits = v, b = y(n_bits), P = 1 << (t - 1), m = P + 1, A = P + 2, x = 0, h = w(), c = 0, i = o;
          i < 65536;
          i *= 2
        )
          ++c
      ...
      function d(t, e) {
        ...
        if (
          ((A > b || C) && (C ? ((b = y((n_bits = v))), (C = !1)) : (++n_bits, (b = n_bits == s ? 1 << s : y(n_bits)))), t == m)
        ) {
